...
$penyakit = penyakit("SELECT * FROM datapenyakit WHERE kd_penyakit = '" . $kd_penyakit . "'")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Ubah Data Penyakit</h1>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="keterangan" style="height: 100px" name="keterangan" required><?php echo $penyakit["keterangan"]; ?> </textarea>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="saran" class="form-label">Saran</label>
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="saran" style="height: 100px" name="saran" required><?php echo $penyakit["saran"]; ?></textarea>
                                    </div>
                                </div>

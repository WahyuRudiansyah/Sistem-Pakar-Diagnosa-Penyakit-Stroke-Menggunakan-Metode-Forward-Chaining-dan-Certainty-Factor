        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tambah Data Penyakit</h1>
                            ...
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="keterangan" name="keterangan" style="height: 100px" required></textarea>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="saran" class="form-label">Saran</label>
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="saran" name="saran" style="height: 100px" required></textarea>
                                    </div>
                                </div>
